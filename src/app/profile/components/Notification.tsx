...
export default function Notification({
	...
	return (
		...
		>
			<div className="bg-gray-200/60 backdrop-blur-md shadow-2xl rounded-b-2xl border-b border-white/40 flex items-center py-4 px-2 gap-2 md:py-6 md:px-4 md:gap-6">
				{/* Title Area: 20% */}
